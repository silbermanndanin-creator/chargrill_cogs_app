...
_ITEMS = [
    # --- 390ml cans (rows 5-9) ---
    ("Coke 390ml",              6,  7, "390ml Cans"),
    ("Coke Zero 390ml",         8, 11, "390ml Cans"),
    ...
    ("Coke Zero 600ml",         8, 11, "600ml Bottles"),
    ("Diet Coke 600ml",         2,  3, "600ml Bottles"),
    ("Vanilla Coke Zero 600ml", 2,  3, "600ml Bottles"),
    ("Fanta 600ml",             3,  4, "600ml Bottles"),
    ("Sprite 600ml",            3,  4, "600ml Bottles"),
    ("Sprite Zero 600ml",       2,  3, "600ml Bottles"),
    ("Fanta Lemon 600ml",       2,  3, "600ml Bottles"),
    ("Pasito 600ml",            2,  3, "600ml Bottles"),
    ("Sparkling Water",         3,  4, "600ml Bottles"),
    ("Water",                   8, 11, "600ml Bottles"),
    # --- Fuze Tea (rows 23-25) ---
    ("Peach Fuze Tea",          3,  4, "Fuze Tea"),
    ("Lemon Fuze Tea",          2,  3, "Fuze Tea"),
    ("Mango Fuze Tea",          3,  4, "Fuze Tea"),
    ...
    ("Coke 1.25L",              2,  3, "1.25L & 1.5L"),
    ("Coke Zero 1.25L",         2,  3, "1.25L & 1.5L"),
    ("Water 1.5L",              2,  3, "1.25L & 1.5L"),
    # --- juice (rows 38-39) ---
